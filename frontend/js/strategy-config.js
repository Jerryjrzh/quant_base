...
const REVERSE_STRATEGY_MAPPING = {
    ...
    // 新迁移的策略
    '价值反转策略（最终版）_v1.0': 'VALUE_REVERSAL',
    '反转做多策略（优化版）_v1.0': 'REVERSED_SHORT',
    // 人工分析逻辑策略
    '年度见底机会策略_v1.0': 'ANNUAL_BOTTOM_OPPORTUNITY',
    '强势股MA13回调策略_v1.0': 'STRONG_STOCK_MA13_PULLBACK',
    '长周期横盘突破策略_v1.0': 'LONG_TERM_CONSOLIDATION_BREAKOUT'
};
