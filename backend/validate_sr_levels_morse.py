...
def process_single_row(task_data):
    ...
    # 兼容 Morse 可能的列名
    stock = row_dict.get('股票代码')
    entry_date = row_dict.get('异动日期(T日)') 
...
def validate_morse_prices_parallel(sample_size=0):
    ...
    """
    csv_path = "/home/hypnosis/data/quant_base/data/morse_analytics/RAW_PRICE_VOL_METRICS_20260526_1055.csv"
    
    try:
        df_csv = pd.read_csv(csv_path)
    except FileNotFoundError:
        csv_path = "data/morse_analytics/RAW_PRICE_VOL_METRICS_20260526_1055.csv"
    ...
    output_path = "/home/hypnosis/data/quant_base/data/result/Calendar_Backtest/morse_price_validation_matrix_v1.1.csv"
