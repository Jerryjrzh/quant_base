...
class AbyssBottomingStrategyV2:
    ...
    def _analyze_volume_shrinkage(self, df):
        ...
        recent_periods = p_volume.get('volume_analysis_periods', 6)
        mid_term_periods = 18
    ...
    def _check_stage1_hibernation(self, df):
        ...
        h_periods = p_hibernation.get('hibernation_periods', 8)
    ...
    def _check_stage2_washout(self, df, hibernation_info):
        ...
        min_pit_periods = p_washout.get('min_pit_periods', 1)
        if len(pit_days_df) < min_pit_periods: return False, {}
